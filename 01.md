...
Monousuário não é igual a monoprogramável, pois, no caso de um sistema monoprogramável, apenas uma tarefa será executada por vez. Em um sistema monousuário não há explicitamente uma limitação (o limite depende recursos disponíveis no computador) para o número de tarefas.